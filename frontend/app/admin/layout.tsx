...
const ADMIN_NAV = [
  ...
  { href: '/admin/listings', label: 'Manage Listings', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
  ...
  { href: '/admin/dealers', label: 'Manage Dealers', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex">
      {/* Mobile hamburger */}
      <button
        className="lg:hidden fixed bottom-4 right-4 z-50 bg-red-600 text-white w-12 h-12 rounded-full shadow-lg flex items-center justify-center"
      ...
      `}>
        <div className="p-4 border-b border-gray-700">
          <p className="font-bold text-lg text-white">Admin Panel</p>
        ...
        <div className="absolute bottom-4 left-0 right-0 px-4">
          <Link href="/dashboard" className="flex items-center gap-2 px-3 py-2 text-sm text-gray-400 hover:text-white transition-colors">
