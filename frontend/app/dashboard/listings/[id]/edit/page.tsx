...
const STEPS = ['Basic Info', 'Location', 'Details', 'Done'];
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-6">
        ...
        {step === 2 && (
          <div>
            <Step3Attributes form={form} onChange={update} onNext={handleSave} onBack={() => setStep(1)} />
        ...
        {step === 3 && (
          <div className="text-center py-8">
            ...
            <p className="text-gray-500 mb-6">Your listing details have been saved successfully.</p>

            {/* Manage photos CTA */}
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6 text-left flex gap-3">
              <span className="text-2xl shrink-0">📸</span>
              <div>
                <p className="font-medium text-blue-900 text-sm">Want to update photos?</p>
                <p className="text-blue-700 text-xs mt-0.5">Upload, delete, or reorder photos separately from your listing details.</p>
              </div>
            </div>
            ...
            <div className="flex gap-3 justify-center flex-wrap">
              ...
              <Link
                href={`/dashboard/listings/${id}/photos`}
