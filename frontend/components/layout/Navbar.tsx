...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white border-b border-gray-200">
      {/* Helpline top bar */}
      {/* <div className="bg-primary-600 text-white text-[12px]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-1.5 flex items-center justify-between">
          <span className="hidden sm:block text-primary-100">
            Palwal&apos;s #1 Property Portal — mypalwal.com
          </span>
          <a
            href="tel:7056070407"
            className="flex items-center gap-1.5 font-semibold hover:text-primary-100 transition-colors ml-auto sm:ml-0"
          >
